import { type LifestylePlan, type LifestyleHabitType, type PostOpState } from "./types";


export const EMPTY_LIFESTYLE: LifestylePlan = [];


export const lifestyleHabitTypes: LifestyleHabitType[] = [
  "Walking",
  "Exercise",
  "Nutrition",
  "Foods to Avoid",
