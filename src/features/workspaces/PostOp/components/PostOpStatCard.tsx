...
export function PostOpStatCard({
  label,
  value,
  icon,
}: {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-white px-3 py-2.5 shadow-[0_1px_2px_rgba(15,23,42,0.03)]">
      <span className="absolute bottom-2 left-0 top-2 w-[3px] rounded-r-full bg-cyan-500" />
      ...
      <div className="flex items-center justify-between gap-3 pl-1">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-[20px] font-bold leading-none text-cyan-700">
            {value}
          </p>
        </div>
